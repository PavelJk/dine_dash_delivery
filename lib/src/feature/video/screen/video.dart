...
import 'package:dine_dash_delivery/src/feature/video/screen/video_player.dart';
...
class _VideoRecipesScreen extends State<VideoRecipesScreen> {
  ...
  final List<Recipe> recipes = [
    Recipe('Завтраки', 'Сырники с малиновым вареньем', '5 мин', 'https://avatars.mds.yandex.net/i?id=e41ffce1744e18f1ee989a3b24d192e507bb03d5-12422251-images-thumbs&n=13', 'assets/videos/2315024861806.mp4'),
    ...
    Recipe('Завтраки', 'Фруктовый смузи в блендере на кефире', '10 мин', 'https://avatars.mds.yandex.net/i?id=5480e74e9362e6c2abab5081e7c1cf22c2b8107d-5231853-images-thumbs&n=13', 'assets/videos/7384962501144.mp4'),
  ...
  Widget _buildRecipeItem(Recipe recipe) {
    return GestureDetector(
      onTap: () {
        ...
        context,
        MaterialPageRoute(
          builder: (context) => VideoPlayerScreen (videoAssetPath: recipe.videoUrl),
        ),
      );
      },
      child: Padding(
...
class Recipe {
  ...
  Recipe(this.category, this.name, this.duration, this.image, this.videoUrl);
}
